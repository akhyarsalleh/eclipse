...
window.runLicenseChecker = function(callback, daysThreshold) {
    ...
    if (expiredDisplayList.length > 0) {
        ...
        var detailsHTML = "<span style='font-weight: bold; color: white; background: #2c3e50; padding: 2px 5px; display: inline-block;'> EXPIRED CREDENTIALS </span><br>" + expiredDisplayList.join('');
